# a7hyprdots
A hyprland config i use, mostly from scartch
with some scripts are from the credits
alongside some scripts i use fairly often

Credits
craftsomething yt config
rofi scripts https://github.com/SsubezZ/hyprland-dots
https://github.com/alrocar/sh1t
